...
% === GitHub (bottom left) ===
\node[service, minimum width=2.2cm] (gh) at (1.2, -3.6) {GitHub\\[-1pt]{\scriptsize Repos + Pages}};

% === Parallel ArXiv (bottom center) ===
\node[box, fill=BrickRed!15, text=BrickRed!80!black, minimum width=2.8cm] (pax) at (5.0, -3.6) {\textbf{Parallel ArXiv}\\[-1pt]{\scriptsize papers.parallelscience.org}};

% === Parallel Review (bottom center-right) ===
\node[box, fill=BrickRed!15, text=BrickRed!80!black, minimum width=2.8cm] (prv) at (8.8, -3.6) {\textbf{Parallel Review}\\[-1pt]{\scriptsize reviews.parallelscience.org}};

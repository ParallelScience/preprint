...
\node[scientist] (da) at (5.6, 0) {
  \textbf{Denario}\\[1pt]
  {\scriptsize\itshape Autonomous fleet}\\[-1pt]
  {\scriptsize Python loop}\\[-1pt]
  {\scriptsize\itshape Denario fleet}
};
...
\node[box, fill=BrickRed!15, text=BrickRed!80!black] (prv) at (8.4, -3.6) {\textbf{Parallel Open Review}\\[-1pt]{\scriptsize reviews.parallelscience}};
